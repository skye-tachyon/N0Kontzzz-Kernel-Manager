...
@Database(entities = [BatteryHistoryEntity::class, BatteryGraphEntry::class, AppProfileEntity::class, CustomTunableEntity::class, GameEntity::class, BenchmarkEntity::class], version = 11, exportSchema = false)
